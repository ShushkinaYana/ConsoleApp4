namespace ConsoleApp4
{
    internal class Program
    {
        ...
        public static void BubbleSort(int[] array) // Сортировка вставки. Затраты: O(1)
        {
        ...
        static void ShakerSort(int[] array) // Сортировка вставки. Затраты: O(1)
        {
        ...
        static void InsertionSort(int[] array) // Сортировка вставки. Затраты: O(n) основной, O(1) дополнительный
        {
